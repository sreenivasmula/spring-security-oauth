...
public class AuthorizationLiveTest {
    ...
    public void givenUser_whenUseBarClient_thenOkForBarResourceReadOnly() {
        ...
        final Response barReadResponse = RestAssured.given().header("Authorization", "Bearer " + accessToken).get("http://localhost:8080/spring-security-oauth-resource/bars/1");
